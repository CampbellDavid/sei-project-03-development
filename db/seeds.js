				...
				return Pub.create([
					{
						...
						description:
							'Join us at Abbey for our Legendary pub quiz. The winning team will walk away with a £250 bar tab to use at Abbey, as well as a trophy to keep until the next quiz. Entry is FREE and complimentary nibbles are provided throughout the evening.',
						maxTeamSize: 8,
						quizDay: 'Tuesday',
						quizTime: '18:30',
					...
					},
					{
						name: 'Clapton Hart',
						image:
							'https://www.telegraph.co.uk/content/dam/food-and-drink/2018/05/21/ClaptonHart-5_trans_NvBQzQNjv4Bq1AT3Q7Sc9uaffdHBes0nLoAUi_eAXJmjTzXoJ-uDM54.jpg?imwidth=450',
						city: 'London',
						...
						description:
							'The Clapton Hart is a friendly pub serving the local community.',
						maxTeamSize: 6,
						quizDay: 'Thursday',
						quizTime: '20:00',
					...
					},
					{
						name: 'White Hart',
						image:
							'https://cdn.thestage.co.uk/wp-content/uploads/2015/05/White-Hart-700x455.jpg',
						city: 'London',
						...
						description:
							'The White Hart is Stoke Newington’s favourite Local in North London’s bohemian and family friendly area. With a massive beer garden out the back, The White Hart is a grand old pub that does what pubs do best ',
						maxTeamSize: 6,
						quizDay: 'Wednesday',
						quizTime: '20:00',
						averagePintCost: '£5.00',
					...
					},
					{
						name: 'Red Lion',
						image:
							'https://media-cdn.tripadvisor.com/media/photo-s/09/9a/34/04/the-red-lion.jpg',
						city: 'London',
					...
					},
					{
						name: 'The George Inn',
						image:
							'https://i1.wp.com/bitaboutbritain.com/wp-content/uploads/2016/03/George_04.jpg?resize=700%2C525',
						city: 'London',
					...
					},
					{
						name: 'The Nags Head',
						image:
							'https://i.pinimg.com/originals/9f/50/9d/9f509d21afccfbd53dfbe619eece9a47.jpg',
						city: 'London',
					...
					},
					{
						name: 'The Lamb & Flag',
						image:
							'https://cdn.londonandpartners.com/asset/lamb-and-flag-1906d1a89dadd412c65deb6451f96fa3.jpg',
						city: 'London',
					...
					},
					{
						...
						image:
							'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSdAyr3k0EAvddGpzKNvy5bmXj_zRcEgaES5gYVW6rs8fbFdd8H',
						city: 'London',
